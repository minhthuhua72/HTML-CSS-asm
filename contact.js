...
function checkBlank() {
    ...
    if (
        ...
        nortification1.innerHTML = "Please select your contact purpose!!!" + "<br/>";
        return false;

    } else if (!preferemail.checked && !preferphone.checked) {
        nortification1.style.display = "block";

        nortification1.innerHTML = "Please select Preferred contact method!!!" + "<br/>";
        return false;
    } else {
...
function checkPhoneNum(){
    ...
    if (num.value.match(pnum)){
      ...
      return true
        ...
        nortification1.style.display= "block"
        nortification1.innerHTML="Please enter a valid phone number!!!"
      return false
    }
  }
  function checkEmail(){
...
function checkboxes() {
    ...
    if (checked > 0) {
        ...
        nortification1.style.display = "block";
        nortification1.innerHTML = "Please select the day which you refer!!!";        
        return false;
    }
}
